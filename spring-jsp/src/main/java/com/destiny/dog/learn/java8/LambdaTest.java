package com.destiny.dog.learn.java8;
...
public class LambdaTest {
	...
	public void test002() {
		...
		map.computeIfAbsent("dog", k -> 23);
		map.computeIfAbsent("dog1", k -> 23);
		map.computeIfPresent("dog", (k, v) -> 90);
		map.computeIfPresent("dog", (k, v) -> 91);
