...
<div>
    ...
    <form id="search_form">
        <table>
            ...
            <tr>
                <td>
                    <button type="button" id="add_btn">新增党员</button>
                </td>
            </tr>
        </table>
...
<script>
    ...
    $(function () {
        ...
        $("#body_content").on("click","button[data-del]",function () {
             ...
             $.get("${pageContext.request.contextPath}/pat/del?id="+ id,function () {
                 alert("删除成功!");
                 load_data();
             })
        ...
        $("#body_content").on("click","button[data-update]",function () {
            ...
            replace_general("${pageContext.request.contextPath}/pat/update?id=" + id, "right_side");
        });


        $("#add_btn").on("click",function () {
            replace_general("${pageContext.request.contextPath}/pat/add", "right_side");
        });
        ...
        function load_data() {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/pat/page",
                type: 'get',
                dataType: "json",
                cache: false,
